          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: <Widget>[
                ...
                reusableTextFields("Enter UserName", Icons.person_outline,
                    false, _userNameTextController),
                const SizedBox(
                  height: 20,
                ),
                reusableTextFields("Enter Email Id", Icons.person_outline,
                    false, _emailTextController),
                const SizedBox(
                  height: 20,
                ),
                reusableTextFields("Enter Password", Icons.lock_outlined, true,
